...
1. **Git** : `git status` ; branche = **`feat/mail-alias-checklist`** (mail/alias) — **[docs/GIT.md](docs/GIT.md)** + **[docs/operations/BRANCHES.md](docs/operations/BRANCHES.md)**.
