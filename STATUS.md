...
| **Avant chaque reprise** | **[docs/operations/DEV-VERIFICATION.md](docs/operations/DEV-VERIFICATION.md) § 0** — `docker info` → **`make test`** → (optionnel) E2E Playwright, `flutter test` Pass, `compose config`. |
