      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-lg p-6 shadow-sm">
          ...
          <p className="mt-4 text-center text-sm text-gray-500 dark:text-slate-400">
            Déjà un compte ? <Link to="/login" className="text-blue-600 dark:text-blue-400 font-medium">Se connecter</Link>
          </p>
        </div>
        <p className="mt-4 text-center text-sm">
          <Link to="/" className="text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-300">← Accueil</Link>
        </p>
      </div>
    </div>
  )
