...
//#endregion
//#region ../../node_modules/cbor-x/iterators.js
/**
...
function encodeIter(objectIterator, options = {}) {
	...
	else if (typeof objectIterator[Symbol.iterator] === "function") return encodeIterSync(objectIterator, options);
	else if (typeof objectIterator.then === "function" || typeof objectIterator[Symbol.asyncIterator] === "function") return encodeIterAsync(objectIterator, options);
...
//#endregion
export { ALWAYS, DECIMAL_FIT, DECIMAL_ROUND, Decoder, Encoder, FLOAT32_OPTIONS, NEVER, REUSE_BUFFER_MODE, Tag, addExtension, clearSource, decode, decodeIter, decodeMultiple, encode, encodeAsAsyncIterable, encodeAsIterable, encodeIter, isNativeAccelerationEnabled, roundFloat32, setSizeLimits };
