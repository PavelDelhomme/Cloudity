...
**Mail OAuth Google** (optionnel, pour admins) : pour une connexion Gmail **en un clic** comme BlueMail, l’admin configure une fois l’OAuth Google. Voir le guide reproductible **[docs/produit/MAIL-GMAIL-OAUTH.md](docs/produit/MAIL-GMAIL-OAUTH.md)**. Sinon, Gmail = email + [mot de passe d’application](https://myaccount.google.com/apppasswords) (comme Thunderbird), sans config.
