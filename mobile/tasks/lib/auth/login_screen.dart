    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(_twoFactorRequired
            ? 'Vérification 2FA — Cloudity Tasks'
            : 'Connexion — Cloudity Tasks'),
      ),
  ...
  Widget _buildLoginForm(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        TextField(
          key: const ValueKey('cloudity_tasks_login_email'),
        ...
        TextField(
          key: const ValueKey('cloudity_tasks_login_password'),
        ...
        Row(
          children: [
            Expanded(
              child: FilledButton(
                key: const ValueKey('cloudity_tasks_login_submit'),
  ...
  Widget _build2FAForm(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        TextField(
          key: const ValueKey('cloudity_tasks_login_2fa_code'),
        ...
        const SizedBox(height: 20),
        FilledButton(
          key: const ValueKey('cloudity_tasks_login_2fa_submit'),
        ...
        const SizedBox(height: 12),
        TextButton(
          key: const ValueKey('cloudity_tasks_login_2fa_cancel'),
