package fr.cloudity.cloudity_ota_installer
...
/**
 * Ouvre l’installeur système sur un APK déjà téléchargé dans le cache de l’app.
 * Aucun navigateur, aucune copie dans Téléchargements.
 */
class CloudityOtaInstallerPlugin :
    FlutterPlugin,
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(binding.binaryMessenger, "cloudity_ota_installer")
    ...
    private fun installApk(path: String) {
        ...
        val authority = "${appContext.packageName}.cloudity.ota"
        ...
        val intent = Intent(Intent.ACTION_VIEW).apply {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                // Cible explicite pour les OEM qui filtrent les intents génériques.
                addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
            }
        }
        // Accorder la lecture aux résolveurs d’installation (PackageInstaller / OEM).
