...
| **H11** | **Coffres verrouillés — suite** | Web : garde locale opt-in Drive/Contacts/Notes (PIN + biométrie) avant affichage/requêtes ; reste à faire ensuite : chiffrement serveur dédié et granularité dossiers/fiches/notes | 🟡 |
