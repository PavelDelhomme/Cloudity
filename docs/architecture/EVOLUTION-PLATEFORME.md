...
> **Liens** : fiches produits et transversal → **[ROADMAP.md](../produit/ROADMAP.md)** ; suivi quotidien → **[STATUS.md](../../STATUS.md)** ; applications mobiles → **[MOBILE-PLATEFORME.md](../produit/MOBILE-PLATEFORME.md)** ; tests → **[TESTS.md](../operations/TESTS.md)** ; index → **[README.md](../README.md)**.
