...
- Vérifier qu’aucun changement ne **casse l’envoi légitime** (timeouts, fallback si service ML absent) — **[../../produit/MAIL.md](../../produit/MAIL.md)**.
- Après montée de charge locale : `make perf-snapshot LABEL=after-antispam-tuning` puis comparer si pertinent (**[PERFORMANCES.md](PERFORMANCES.md)**).
