...
|--------|------|-----------------------------|
| **Fondation** | Identité, auth, chiffrement des secrets, sync technique, notifications, **recherche / indexation**, design system, **observabilité** | auth-service, gateway, jobs, **[PERFORMANCES.md](../operations/PERFORMANCES.md)**, **TR-06**, **[SECURITE.md](../securite/SECURITE.md)** |
...
8. **Permissions** — un modèle unifié (lecture, édition, partage, délégation, audit) sur la durée — **[SECURITE.md](../securite/SECURITE.md)**.
...
| Besoin | Fichier |
|--------|---------|
| Actions quotidiennes | **[TODO.md](../operations/TODO.md)** |
