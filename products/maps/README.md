...
- Stacks / volumes **séparés** de Gasoil (`products/fuel`) et JobbingTrack.
...
Référence : `products/fuel/docs/cloudity-maps-navigation.md` (repo GasoilTracking).

## Prochaine étape

Créer le repo `PavelDelhomme/CloudityMaps` (ou équivalent) et le brancher ici en submodule, comme `fuel/` et `jobbing-track/`.
