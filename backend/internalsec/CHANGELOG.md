...
> Convention : tant que la lib n'est pas publiée sur l'org GitHub définitive (cf. **MULTI-REPO.md** Q4=B), aucun tag Git `internalsec/v*` n'est poussé. Les versions sont déclarées ici et appliquées en tags **dès que l'org cible est fixée**.
